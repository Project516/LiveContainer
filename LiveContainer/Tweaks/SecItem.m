...
void SecItemGuestHooksInit(void)  {
    ...
    if(keychainGroupId == 0) {
        accessGroup = [NSString stringWithFormat:@"%@.org.spectrum3847.spectrum-mobile.shared", groupId];
    } else {
        accessGroup = [NSString stringWithFormat:@"%@.org.spectrum3847.spectrum-mobile.shared.%d", groupId, keychainGroupId];
    }
